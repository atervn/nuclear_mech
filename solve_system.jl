function solve_system!(enve::envelopeType, chro::chromatinType, spar::scaledParametersType ,simset::simulationSettingsType ,dt::Number, ext, noEnveSolve::Bool )
...
function solve_system!(enve, spar,simset,dt,ext)
    ...
    # enve.normalVolume -= 1000*dt.*simset.timeStepMultiplier
