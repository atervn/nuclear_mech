...
function vertex_triangle_distance(nucleus, p, tri)

    tri = nucleus.tri[tri,:];

    B = [nucleus.x[tri[1]], nucleus.y[tri[1]], nucleus.z[tri[1]]];
    E0 = [nucleus.x[tri[2]], nucleus.y[tri[2]], nucleus.z[tri[2]]] .- B;
    E1 = [nucleus.x[tri[3]], nucleus.y[tri[3]], nucleus.z[tri[3]]] .- B;
    D = B .- [nucleus.x[p], nucleus.y[p], nucleus.z[p]];
